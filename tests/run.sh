...
for name in wc-tail-parity text-tools-parity util-linux-smoke system-smoke seq-parity sort-parity zstd-check hostid-check free-check timeout-check uptime-check truncate-check cp-check tail-check mv-check du-check crypto-check ar-check diff-check grep-parity cut-parity stat-parity; do
